...
function InstagramProject(props) {
    if (props.projectName == "Instagram AR") {
       return(
        <Link to={'/instagram'} style={{textDecoration: 'none'}} className="halfLink">
            <div id="half-cover-project-div">
                    <div id='half-cover-img-div'>
                        <img id="half-cover-img" src={props.bg} />
                    </div>
...
function HalfCoverProject(props) {
    return (
        <div>
            ...
            <InstagramProject bg={props.bg} role={props.role} projectName={props.projectName} type={props.type} description={props.description} theme={props.theme} url={props.url}/>
        </div>
