...
function DesignList() {
    const design = [{bg: require('../Assets/instagram_bg.png'), role: "AR DESIGN, AR PROTOTYPING", projectName: "Instagram AR", type: "Internship", description: "New Instagram AR effects utilizing the hand-tracking capability.", theme: 0, url: 'https://www.lingshuangkong.com/work/instagram'}, 
