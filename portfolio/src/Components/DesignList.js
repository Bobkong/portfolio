...
function DesignList() {
    const design = [{bg: require('../Assets/instagram_bg.png'), role: "AR DESIGN, UI/UX DESIGN, B2C DESIGN", projectName: "Instagram AR", type: "AR Design Intern", description: "I empowered users to creatively express themselves by launching new Instagram AR effects utilizing the hand-tracking capability.", theme: 0, url: 'https://www.lingshuangkong.com/work/instagram'}, 
    {bg: require('../Assets/homni_bg.png'), role: "UX/UI DESIGN, USER RESEARCH, B2B DESIGN", projectName: "Homni Stroke Detector", type: "UI/UX Design Intern", description: "I helped stroke nurses and doctors save stroke patients' life more confidently by designing the machine learning-driven stroke detector application.", theme: 1, url: 'https://lingshuang.webflow.io/work/homni-health'},
