...
function SelfIntro() {
    ...
    <div id='self-intro-div'>
        ...
        <div id='self-text'>
            <p id='intro-title'><span>Lingshuang is a designer and prototyper who has 7 years of development experience, with an enormous passion for </span>UI/UX, AR/VR, <span>and</span> Design Engineering.</p>
