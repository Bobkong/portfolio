    ...
    return(
        <div style={{width: "70vw",
            ...
            marginBottom: "10rem"}}>
                ...
                <p className='headline-large neutrals' style={{marginTop: "1rem"}} >
                    I am proud to announce that ARound, the revolutionary navigation solution, has received the prestigious <span className="white headline-large-bold">Best of Navigation Award</span>, along with a prize of 5000 USD. Outshining 1100 participants, ARound's innovation and impact on navigation stood out among the competition.
                </p>
