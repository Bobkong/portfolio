...
const ColorShiftMaterial = shaderMaterial(
  { time: 0, color: new Color(0.2, 0.0, 0.1), opacity: 0 },
  // vertex shader
  `
    uniform float time;
    varying vec2 vUv;
    ...
    void main() {
      ...
      pos = rotateAxis(pos, vec3(0., 1., 0.), sin(pos.x * 1.) * 3.14 * .4);
    ...
    <mesh rotation={[0, 0, rotZ]}>
      ...
      */}
        ...
        <WebGLText
          ...
          position={[0, 0, Math.min(scale.width, scale.height) * 0.7]}
